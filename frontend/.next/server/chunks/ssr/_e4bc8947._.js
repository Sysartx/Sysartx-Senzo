...
"[project]/src/app/(admin)/plan-settings/page.tsx [app-ssr] (ecmascript)": ((__turbopack_context__) => {
"use strict";

__turbopack_context__.s({
    "default": ()=>PlanSettingsPage
});
var __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2d$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/node_modules/next/dist/server/route-modules/app-page/vendored/ssr/react-jsx-dev-runtime.js [app-ssr] (ecmascript)");
...
function PlanSettingsPage() {
    const [activeCategory, setActiveCategory] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["useState"])("information");
    ...
    const [editItem, setEditItem] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["useState"])({
        name: "",
        description: ""
    });
        ...
        information: [
            {
                id: "1",
                name: "Plan Overview",
                description: "General plan information"
            },
            {
                id: "2",
                name: "Budget Details",
    ...
    const filteredData = data[activeCategory].filter((item)=>item.name.toLowerCase().includes(searchTerm.toLowerCase()) || item.description && item.description.toLowerCase().includes(searchTerm.toLowerCase()));
    const handleAddItem = ()=>{
        ...
        __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$sonner$2f$dist$2f$index$2e$mjs__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["toast"].success(`${activeCategory.charAt(0).toUpperCase() + activeCategory.slice(1)} added successfully`);
    ...
    const handleEditClick = (id)=>{
        ...
        if (!item) {
            __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$sonner$2f$dist$2f$index$2e$mjs__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["toast"].error("Item not found");
            return;
        }
        setItemToEdit(item);
        setEditItem({
    ...
    const handleUpdateItem = ()=>{
        ...
        setData((prev)=>({
                ...prev,
                [activeCategory]: prev[activeCategory].map((item)=>item.id === itemToEdit.id ? {
                        ...item,
                        name: editItem.name,
                        ...activeCategory === "information" || activeCategory === "types" || activeCategory === "categories" ? {
    ...
    const handleConfirmDelete = ()=>{
        ...
        __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$sonner$2f$dist$2f$index$2e$mjs__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["toast"].success(`${itemName} deleted successfully`);
    ...
    return /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2d$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
        ...
        children: [
            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2d$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["jsxDEV"])("h1", {
                ...
                children: "Plan Settings"
            }, void 0, false, {
                fileName: "[project]/src/app/(admin)/plan-settings/page.tsx",
                lineNumber: 163,
                columnNumber: 7
            }, this),
                                ...
                                children: /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2d$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["jsxDEV"])("tr", {
                                    children: [
                                        ...
                                        [
                                            ...
                                            "types",
                                            "categories"
                                        ].includes(activeCategory) && /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2d$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["jsxDEV"])("th", {
                                            className: "px-6 py-3 text-left text-xs font-medium text-gray-500 uppercase tracking-wider",
                                ...
                                children: filteredData.length > 0 ? filteredData.map((item)=>/*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2d$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["jsxDEV"])("tr", {
                                        children: [
                                            ...
                                            [
                                                ...
                                                "types",
                                                "categories"
                                            ].includes(activeCategory) && /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2d$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["jsxDEV"])("td", {
                                            ...
                                            [
                                                ...
                                                className: "px-6 py-4 whitespace-nowrap text-sm text-gray-500",
                                                children: /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2d$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["jsxDEV"])("span", {
                                                    className: `px-2 py-1 rounded-full text-xs ${item.status === "Active" || item.status === "Approved" ? "bg-green-100 text-green-800" : "bg-yellow-100 text-yellow-800"}`,
                                    ...
                                    children: /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2d$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["jsxDEV"])("td", {
                                        colSpan: [
                                            ...
                                            "types",
                                            "categories"
                                        ].includes(activeCategory) ? 3 : [
                                            "locations",
                                            "providers"
                                        ].includes(activeCategory) ? 3 : 2,
                        ...
                        /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2d$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                            ...
                            children: [
                                ...
                                [
                                    ...
                                    "types",
                                    "categories"
                                ].includes(activeCategory) && /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2d$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                    children: [
                                        /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2d$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["jsxDEV"])("label", {
                                            className: "block text-sm font-medium mb-1",
                                            children: "Description"
            ...
            isEditModalOpen && itemToEdit && /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2d$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                className: "fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center z-50",
                children: /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2d$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                    className: "bg-white rounded-lg p-6 w-full max-w-md",
                    children: [
 ...
 //     const itemToEdit = data[activeCategory].find(item => item.id === id);
 //     if (!itemToEdit) {
 ...
 //     toast.info(`Editing ${activeCategory} item: ${itemToEdit.name}`);
 //   };
 //   const handleDelete = (id: string) => {
 //     const itemToDelete = data[activeCategory].find(item => item.id === id);
 //     if (!itemToDelete) {
 //       toast.error("Item not found");
 //       return;
 //     }
 ...
 //         <Button
 //           variant={activeCategory === "information" ? "default" : "outline"}
 //           onClick={() => setActiveCategory("information")}
 //           className="py-6 flex flex-col items-center"
 //         >
 ...
 //         </Button>
 //         <Button
 //           variant={activeCategory === "providers" ? "default" : "outline"}
 ...
 //         </Button>
 //         <Button
 //           variant={activeCategory === "categories" ? "default" : "outline"}
 ...
 //   const data: Record<Category, DataItem[]> = {
 //     information: [
 //       { id: "1", name: "Plan Overview", description: "General plan information" },
 //       { id: "2", name: "Budget Details", description: "Financial information" },
 //       { id: "3", name: "Timeline", description: "Project schedule" },
 ...
 //     alert(`Adding new ${activeCategory}: ${newItem.name}`);
 //     setIsAddModalOpen(false);
 //     setNewItem({ name: "", description: "" });
 //   };
 //   const handleEdit = (id: string) => {
 //     // Edit functionality would go here
 //     alert(`Editing ${activeCategory} item with ID: ${id}`);
 //   };
 //   const handleDelete = (id: string) => {
 //     // Delete functionality would go here
 //     alert(`Deleting ${activeCategory} item with ID: ${id}`);
 //   };
 //   return (
 //     <div className="container mx-auto px-4 py-8 text-black">
 //       <h1 className="text-2xl font-bold mb-8">Plan Settings</h1>
...
//# sourceMappingURL=_e4bc8947._.js.map